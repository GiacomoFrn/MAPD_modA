...
entity fir_filter is
    generic(
        ...
        SCALING    : integer:=2  -- scaling factor for coefficients -> should be coeff_width -1 if coeff in (-1,1)
    );
    port (
        i_clk   : in  std_logic;
...
architecture rtl of fir_filter is
    ...
    --signal s_coeff   : t_coeff:= (others => (others => '0'));                        -- container for coefficients
