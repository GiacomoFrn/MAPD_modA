...
HD_PWD='C:/Users/giaco/Documents/Uni/PoD/MaPD/MAPD_modA/10_synchronizer/10_synchronizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync.tcl
