...
HD_PWD='C:/Users/giaco/Documents/Uni/PoD/MaPD/MAPD_modA/11_state_machines/11_state_machines.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_fsm1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_fsm1.tcl
