...
HD_PWD='C:/Users/giaco/Documents/Uni/PoD/MaPD/MAPD_modA/12_pattern_detect/12_pattern_detect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log patterndetect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source patterndetect.tcl
