...
HD_PWD='C:/Users/giaco/Documents/Uni/PoD/MaPD/MAPD_modA/12_pattern_detect/12_pattern_detect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log patterndetect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source patterndetect.tcl -notrace
